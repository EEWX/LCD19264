...
#define LCD19264_SCK_GPIO GPIOC //data clock
#define LCD19264_SCK_PIN GPIO_PIN_7

#define LCD19264_SDA_GPIO GPIOC  //data
#define LCD19264_SDA_PIN GPIO_PIN_6

#define LCD19264_RST_GPIO GPIOC
#define LCD19264_RST_PIN GPIO_PIN_3

#define LCD19264_CD_GPIO GPIOC  //command data
#define LCD19264_CD_PIN GPIO_PIN_5

#define LCD19264_CS_GPIO GPIOC
#define LCD19264_CS_PIN GPIO_PIN_4

#define LCD19264_LED_GPIO GPIOD
#define LCD19264_LED_PIN GPIO_PIN_2

#define LCD_SCK_SET	GPIO_WriteHigh(LCD19264_SCK_GPIO,LCD19264_SCK_PIN)
#define LCD_SDI_SET	GPIO_WriteHigh(LCD19264_SDA_GPIO,LCD19264_SDA_PIN)
#define LCD_RST_SET	GPIO_WriteHigh(LCD19264_RST_GPIO,LCD19264_RST_PIN)
#define LCD_A0_SET	GPIO_WriteHigh(LCD19264_CD_GPIO,LCD19264_CD_PIN)
#define LCD_CS_SET	GPIO_WriteHigh(LCD19264_CS_GPIO,LCD19264_CS_PIN)
#define LCD_LED_SET	GPIO_WriteHigh(LCD19264_LED_GPIO,LCD19264_LED_PIN)

#define LCD_SCK_RESET	GPIO_WriteLow(LCD19264_SCK_GPIO,LCD19264_SCK_PIN)
#define LCD_SDI_RESET	GPIO_WriteLow(LCD19264_SDA_GPIO,LCD19264_SDA_PIN)
#define LCD_RST_RESET	GPIO_WriteLow(LCD19264_RST_GPIO,LCD19264_RST_PIN)
#define LCD_A0_RESET	GPIO_WriteLow(LCD19264_CD_GPIO,LCD19264_CD_PIN)
#define LCD_CS_RESET	GPIO_WriteLow(LCD19264_CS_GPIO,LCD19264_CS_PIN)
#define LCD_LED_RESET	GPIO_WriteLow(LCD19264_LED_GPIO,LCD19264_LED_PIN)
